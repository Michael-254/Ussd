...
class BulkSmsService
{
     ...
     *
     * @return Evans\BulkSms\Sender\Single
     */
    ...
    public function sendBulkMessages(array $messages, array $params = null)
    {
        ...
        foreach ($messages as $message) {
            ...
            v::instance('Evans\BulkSms\Message')->check($message);
     ...
     * Create a message sender instance.
     *
     * @return Evans\BulkSms\Sender\Bulk
     */
     ...
     * Create a message sender instance.
     *
     * @return Evans\BulkSms\Sender\Status
     */
