...
class ParseRecipientTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->message = new \Evans\BulkSms\Message("4712345678", "text");
    ...
    {
        $this->message = new \Evans\BulkSms\Message('47 12345678', "text");
        $this->assertRecipientEquals('4712345678');
    }
    ...
    {
        $this->message = new \Evans\BulkSms\Message('12345678', "text");
        $this->assertRecipientEquals('4712345678');
    }
    ...
    {
        $this->message = new \Evans\BulkSms\Message(1234567, "text");
    }
}
